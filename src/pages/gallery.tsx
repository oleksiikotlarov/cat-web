...
const gallery: React.FC<{ data: CatImageData[] }> = ({ data }) => {
    ...
    <main>
      <div className="">
        <Wrapper>
          ...
          <motion.div
            ...
            <div className="grid sm:grid-rows-3 grid-rows-4 gap-4 sm:gap-4 items-center sm:mb-6 w-full">
              <div className="flex items-center justify-between">
                <div className="flex justify-stretch items-center mr-2 gap-2">
                  <Link
                    href="/"
                ...
                <div
                  className="flex items-center text-[#FF868E] text-lg font-medium bg-[#FBE0DC] gap-2 rounded-lg py-1 px-6 group-hover:bg-[#FBE0DC] duration-100 group hover:bg-[#FF868E] hover:text-white"
                  onClick={() => {
                    setModalOpen(!modalOpen);
                    console.log(1)
                  }}>
                  <svg
                    className="fill-[#FF868E] group-hover:fill-white"
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
      ...
      {modalOpen && (
        <motion.div
          ...
          w-full items-center  justify-center bg-[#1D1D1D99] bg-opacity-60 gap-24 text-2xl font-bold h-screen ">
